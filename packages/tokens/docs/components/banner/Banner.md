...
- ❌ DONT: Use Banner for marketing, content promotion, branded themes, or rich media; those belong to Promotion, not system messaging.
...
- [ ] Banner is used only for page-status or system-state communication, not promotion or content messaging.
