...
Dividers create visual separation between content sections. Use a dashed divider for editorial content breaks and a solid divider for structural UI separation. Supports horizontal and vertical orientations.
...
| -------------- | ------------- | ------- | ------------------------ | ------------ | ---------------------------------------------------------------------------------- |
| `style`        | `variant`     | string  | `dashed`, `solid`        | `dashed`     | Sets the line style. Dashed for editorial breaks, solid for structural separation. |
...
- Use a **dashed** divider between editorial content sections (e.g. article lists, feed items).
...
- [ ] Use `style=dashed` for editorial contexts and `style=solid` for structural UI.
