...
| `fontSize140` | 2.5rem (40px) | 2.5rem (40px) | 2.5rem (40px) | 3.5rem (56px) | Extra-large display, content |
...
- Used for content, marketing pages, headings
...
- ✅ Content content with flexible hierarchy
...
Fixed-size decorative heading scale. Not for headlines. Use `p` or `span` with no semantic heading role.
