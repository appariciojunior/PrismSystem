...
- Content content with complex layouts (articles, features, marketing pages)
...
- Best for: Content pages, documentation
...
3. **Content requirements**: Content needs demand different layouts
