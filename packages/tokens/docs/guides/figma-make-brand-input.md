...
- Context: Non-content experiences (utility, wayfinding, account areas, settings, authentication, general UI)
...
- **Inter** - UI elements, navigation, captions, metas (sizes: 18px, 16px, 14px, 12px)
