...
```
"Fixed light-weight editorial heading at 19px. Typically h5, h6."
...
```
"Fixed light editorial heading at 19px. Pair with `h5` or `h6`."
...
- `brand.heading.fluid.light.2xsmall` → "Subtle editorial subheading..."
...
Example: "Subtle editorial subheading for article sections and tertiary content. Typically h5, h6."
...
Example: "Micro heading. Tertiary article section breaks. Pair with `h5` or `h6`."
...
**Current issue:** "Fixed [weight] editorial heading at [size]px"
...
```
"Fixed light-weight editorial heading at 19px. Typically h5, h6."
"Fixed light-weight editorial heading at 20px. Typically h5, h6."
"Fixed light-weight editorial heading at 24px. Typically h4, h5."
```
