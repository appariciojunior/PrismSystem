...
- ❌ Before: "[Weight] content [context] for [use case]. Typically [HTML]."
...
| Aspect | Before | After |
| ------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| Description | "Subtle subheading for sections and tertiary content. Typically h5, h6." | "Micro heading. Tertiary section breaks. Pair with `h5` or `h6`." |
| Active Voice | ✗ Passive "for sections" | ✓ Direct "section breaks" |
...
| Aspect | Before | After |
| ------------ | -------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| Description | "Article subheading or secondary headline for opinion pieces. Typically h4, h5." | "Small heading. Secondary hierarchy. Pair with `h4` or `h5`." |
| Active Voice | ✗ "for opinion pieces" | ✓ "secondary hierarchy" |
...
| Aspect | Before | After |
| ------------ | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| Description | "Standard heading for sections and cards. Typically h3, h4." | "Standard headline. Sections and cards. Pair with `h3` or `h4`." |
| Active Voice | ✗ "for content sections" (vague usage) | ✓ Direct context |
| Redundancy | ✗ "Standard heading" + token | ✓ "Standard headline" only |
...
| Aspect | Before | After |
| ------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| Description | "Lead heading for hero and top-level content. Typically h1, h2." | "Lead headline. Hero and top-level content. Pair with `h1` or `h2`." |
| Active Voice | ✗ "for home screen" | ✓ Direct context |
| Redundancy | ✗ "Lead heading" | ✓ "Lead headline" only |
...
| Aspect | Before | After |
| ------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| Description | "Body-weight subheading for accessible hierarchy. Typically h5, h6." | "Accessible micro heading. Content hierarchy. Pair with `h5` or `h6`." |
| Active Voice | ✗ "for accessible hierarchy" (vague) | ✓ Direct role |
...
| Aspect | Before | After |
| ------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------ |
| Description | "Lead heading balancing authority and readability. Typically h2, h3." | "Balanced lead headline. Major content. Pair with `h2` or `h3`." |
| Active Voice | ✓ "balancing" is active | ✓ Clearer: "balanced lead" |
| Redundancy | ✗ "Lead heading" + "balancing" | ✓ "Balanced lead headline" only |
...
| Aspect | Before | After |
| ------------ | -------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Description | "Major heading for hero sections. Typically h1, h2." | "Major headline. Home screen hero and top stories. Pair with `h1` or `h2`." |
| Active Voice | ✗ "for hero sections" | ✓ Direct context |
| Redundancy | ✗ "Major heading" + token | ✓ "Major headline" only |
...
| Aspect | Before | After |
| ------------ | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| Description | "Extra-bold subheading for emphasis and callouts. Typically h4, h5." | "Extra-bold subheading. Content emphasis and callouts. Pair with `h4` or `h5`." |
| Active Voice | ✗ "for emphasis" (vague) | ✓ Direct context |
| Redundancy | ✗ "Extra-bold subheading" + "emphasis" | ✓ Context clear |
| Audience | ✗ Design-only | ✓ All: tone (extra-bold), use (emphasis/callouts), code |
...
| Aspect | Before | After |
| ------------ | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Description | "Ultra-bold lead headline for major statements. Typically h2, h3." | "Authoritative headline. Major statements. Pair with `h2` or `h3`." |
| Active Voice | ✗ "for major statements" | ✓ Direct context |
