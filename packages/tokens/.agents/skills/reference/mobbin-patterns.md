...
The DNA's anti-pattern list ends with **borrowed identities**: "if the design could have come from any other newspaper or any other product, the design has failed." Mobbin makes borrowing effortless, so this skill makes the boundary explicit.
