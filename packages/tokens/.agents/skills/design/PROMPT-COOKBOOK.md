...
**What you get back:** around six quick, rough versions, each from a different angle: denser and more editorial, image-led, calmer and more open, bolder headline, mobile-first, a different type treatment. They are lined up so you can compare, pick one, or mix two. Only the one you choose gets built properly afterwards.
