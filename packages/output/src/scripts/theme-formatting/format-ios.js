...
const generateTypographyInterface = (typographyTokens) => {
  ...
  const bodyTokens = switchCaseTokens(/Body|Standfirst|Paragraph|Link/);
  const calloutTokens = switchCaseTokens(/Byline|Button|Label/);
  const footnoteokens = switchCaseTokens(/Caption|Standfirst/);
