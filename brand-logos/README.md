...
This starter ships without logo files. The originals that lived here were brand-specific and have been removed. Add your own before generating screens that show a display, navigation bar or footer.
...
|---|---|---|
| `logo-light.svg` | Primary wordmark or logotype, dark ink | Light surfaces: displays, print-like headers |
