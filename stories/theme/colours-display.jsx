...
export const FoundationDisplay = () =>
 generatePalettes({
 brand: (theme.foundation && theme.foundation.brand) || {},
 marketing: (theme.foundation && theme.foundation.marketing) || {},
 'data-vis': (theme.foundation && theme.foundation['data-vis']) || {}
 });

export const BrandsDisplay = () => generatePalettes((theme['light/ brand'] && theme['light/ brand'].ramp) || {});

// Brand-neutral semantic accent tiers. Replaces the removed product channels.
...
export const MarketingDisplay = () =>
 generatePalettes(theme['light/ marketing'] || (theme.foundation && theme.foundation.marketing) || {});

export const CoreDisplay = () => generatePalettes(theme['light/ core']);

export const DataVisDisplay = () =>
 generatePalettes(theme['light/ dataVisualisation'] || (theme.foundation && theme.foundation['data-vis']) || {});
