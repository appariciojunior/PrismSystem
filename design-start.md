...
**A few different directions** (Versions): generate several takes (default six), each from a genuinely different angle: denser and more content, image led, calmer and more open, a bolder headline, a mobile-first layout, a different section colour. Keep them rough and quick. Then line them up, and help the designer pick one or mix two together. Only the chosen one gets built properly later.
