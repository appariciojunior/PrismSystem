...
- **Avoid redundancy with token path.** The token name already says `heading`, `fluid`, `light`, etc.
  - ✓ "Small editorial headline. News stories and features. Pair with `h3` or `h4`."
  - ✗ "Light-weight editorial heading for small news stories and features. Pair with `h3` or `h4`."
...
✓ "Light heading for subtle editorial hierarchy."
...
- "Small body text for dense editorial layouts."
- "Byline for author attribution on article pages."
...
✓ Context without classification (news stories)
